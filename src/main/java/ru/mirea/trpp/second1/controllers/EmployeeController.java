package ru.mirea.trpp.second1.controllers;
...
import ru.mirea.trpp.second1.entity.Employee;
...
public class EmployeeController {
    ...
    public EmployeeController() {
        employeeList = new CsvToBeanBuilder<Employee>(new InputStreamReader(Objects.requireNonNull(this
                .getClass().getResourceAsStream("/MOCK_DATA.csv")))).withType(Employee.class).build().parse();
    }
